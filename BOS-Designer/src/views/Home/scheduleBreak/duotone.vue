 ...
 <C-Main-Block>
    ...
    <section class="relative p-4">
      <div class="mb-4 flex items-center justify-between gap-2">
        ...
        <font-awesome-icon
          :icon="isActiveCalendar ? 'fa-regular fa-list' : 'fa-regular fa-calendar-days'"
          class="w-[24px] text-2xl"
      ...
      <transition name="collapseTransition">
        ...
        >
          <template v-slot:header="{ year, monthLabel, movePrevMonth, moveNextMonth }">
            <div class="absolute inset-x-0 top-[-50px] flex items-center justify-between">
              <span @click="movePrevMonth" @keypress="movePrevMonth" class="ml-0 text-xl">
              ...
              <span @click="movePrevMonth" @keypress="moveNextMonth" class="mr-0 text-xl">
